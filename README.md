...
Generated by `python dashboard/build_report.py` into a single self-contained
`dashboard/report.html`.

<table>
  <tr>
    <td width="50%" valign="top">
      <img src="images/result1.png" alt="Key metrics: facility and HVAC electricity saved, comfort violations, and agent telemetry" width="100%">
      <sub><b>Key metrics.</b> Savings, comfort violations, and agent telemetry — decisions, latency, self-corrections, fallbacks, cache hit rate.</sub>
    </td>
    <td width="50%" valign="top">
      <img src="images/result3.png" alt="Controller comparison table: kWh, savings, HVAC kWh, peak kW and comfort violations per controller" width="100%">
      <sub><b>Results at a glance.</b> Every figure read straight from <code>eplusout.csv</code>, the EnergyPlus output itself.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="images/result2.png" alt="Area chart of cumulative electricity saved versus baseline for the rule-based and LLM controllers" width="100%">
      <sub><b>Savings accumulating over time.</b> The gap between the two lines is what the LLM's situational reasoning adds over a fixed rule.</sub>
    </td>
    <td width="50%" valign="top">
      <img src="images/result14.png" alt="Table comparing the three-week run against the season-long endurance run" width="100%">
      <sub><b>Endurance.</b> The identical pipeline over three months — nothing that must stay at zero moved, and the cache got markedly better.</sub>
    </td>
  </tr>
</table>
